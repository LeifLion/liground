<template>
  <div>
    <div class="containerEvalBar" v-if="this.QuickTourIndex !=10">
      <div
        class="eval"
    ...
    <div class="containerEvalBar-qt" v-else>
      <div
        class="eval"
        :class="{ smaller: cpForWhiteStr.includes('/') }"
      >
    ...
    <div class="analysis">
      <!-- <AnalysisEvalRow /> -->
      <EngineStats ref="enginestats" v-if="this.QuickTourIndex !=11"/>
      <EngineStats id="EngineStats-qt" ref="enginestats" v-else/>
      <div
      ...
      <PVLines
        ref="pvlines"
        class="panel"
        v-if="this.QuickTourIndex !=12"
      />
      <PVLines
        ref="pvlines"
        class="panel-qt"
        v-else/>
      <div class="game-window panel noselect" v-if="this.QuickTourIndex !=13">
        <div id="move-history">
          <MoveHistoryNode
            v-if="movesExist"
            :move="mainFirstMove"
      ...
      <div class="game-window-qt" v-else>
      <div
        id="move-history"
      >
        <MoveHistoryNode

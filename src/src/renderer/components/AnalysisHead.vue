<template>
  <div class="ceval grid-parent">
    ...
    <Mode960 v-if="this.QuickTourIndex!=8"/>
    <Mode960 id="Mode960-qt" v-else/>
    <div id="PvESwitch" v-if="this.QuickTourIndex!=9">
    PvE
    <PvESwitch />
    </div>
    <div id="PvESwitch-qt" v-else>
    PvE
    <PvESwitch />
    </div>
  </div>
